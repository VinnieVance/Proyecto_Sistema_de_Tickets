<?php
    class Subcategoria extends Conectar{ #Clase Categoria extendida de Conectar
        ...
        /* Para mostrar todos los registros sin filtro */
        ...
        /* Funcion para insertar nueva subcategoria */
        public function insert_subcategoria($cat_id,$cats_nom){
            $conectar= parent::conexion();
            parent::set_names();
            $sql="INSERT INTO tm_subcategoria 
                (cats_id,cat_id,cats_nom,est) 
                VALUES (NULL,?,?,'1');";
            $sql=$conectar->prepare($sql);
            $sql->bindValue(1, $cat_id);
        ...
        /*  Funcion mostrar las subcategorias por id*/
