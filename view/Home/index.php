...
<html>
	...
	<link rel="stylesheet" href="../../public/css/lib/fullcalendar/fullcalendar.min.css">
  	<link rel="stylesheet" href="../../public/css/separate/pages/calendar.main.css">
	
	<title>UAEM Sistema de Tickets:::Inicio</title>
...
<body class="with-side-menu">
	...
	<div class="page-content">
		<div class="container-fluid">
			<!-- Cuadros con total de tickets, total abiertos y cerrados -->
			<div class="row">
				<div class="col-x1-12">
					<div class="row">
						<div class="col-sm-4">
